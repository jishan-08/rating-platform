    ...
    return (
        <section className="auth-page page-container">
            <Card className="auth-card">
                ...
                <div style={{ marginTop: "1.25rem", borderTop: "1px solid var(--line)", paddingTop: "0.85rem", textAlign: "center", fontSize: "0.85rem" }}>
                    <Link to="/admin/login" style={{ color: "var(--muted)", fontWeight: 600 }}>
